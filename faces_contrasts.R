...
pre_contrasts<-read.delim('//zi.local/flstorage/dep_psm/group_psm/AG-Paret/Projects/BrainBoost/data_analysis/spm_analysis/firstlevel/ses-pre/task-faces/taskrelated_activity/original/ROI-cons_mask-Right Amygdala 25_1_roi.txt')
post_contrasts<-read.delim('//zi.local/flstorage/dep_psm/group_psm/AG-Paret/Projects/BrainBoost/data_analysis/spm_analysis/firstlevel/ses-post/task-faces/taskrelated_activity/original/ROI-cons_mask-Right Amygdala 25_1_roi.txt')
fu_contrasts<-read.delim('//zi.local/flstorage/dep_psm/group_psm/AG-Paret/Projects/BrainBoost/data_analysis/spm_analysis/firstlevel/ses-fu/task-faces/taskrelated_activity/original/ROI-cons_mask-Right Amygdala 25_1_roi.txt')
